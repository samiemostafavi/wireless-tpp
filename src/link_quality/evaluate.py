...
def evaluate_model(args):
    ...
    if prediction_config['dataset']:
        dataset_path = Path(prediction_config['dataset']) / "link_quality" / "datasets" / prediction_config['dataset_name']
    else:
        dataset_path = Path(args.source) / "link_quality" / "datasets" / args.name
    ...
    config = {
        ...
        experiment_id: {
            ...
            "model_config": {
                ...
                "num_heads": training_output_config['model_config']['num_heads'],
